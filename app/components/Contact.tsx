            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div>
                    ...
                    <p className="text-gray-400 text-lg mb-10 leading-relaxed max-w-md">
                        Have questions about your Eldvora portfolio? Our institutional support team is available 24/7 to assist with technical or financial queries.
                    </p>

                    <div className="space-y-6">
                        <a href="mailto:support@eldvora.com" className="flex items-center gap-6 p-6 bg-[#0F172A] border border-gray-800 rounded-[30px] hover:border-blue-500/50 transition group">
                            ...
                            <div>
                                ...
                                <div className="text-white font-bold">support@eldvora.com</div>
                            </div>
                        </a>
                        ...
                        <a href="#" className="flex items-center gap-6 p-6 bg-[#0F172A] border border-gray-800 rounded-[30px] hover:border-blue-500/50 transition group">
                            ...
                            <div>
                                ...
                                <div className="text-white font-bold">@Eldvora_Official</div>
                            </div>
                        </a>
                    </div>
                </div>
