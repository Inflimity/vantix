...
export default function FAQ() {
    ...
    const faqs = [
        {
            question: "What exactly is Eldvora INC LTD?",
            answer: "Eldvora INC LTD is a legally registered UK investment company. We utilize professional traders and high-frequency algorithms in Forex, Crypto Exchange, and Mining to generate consistent hourly profits for our members."
        },
        {
    ...
    return (
        <section id="faq" className="py-20 max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-400">Everything you need to know about investing with Eldvora INC LTD.</p>
            </div>
